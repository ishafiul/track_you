...
#ifndef TRACK_YOU_CORE_IOS_SWIFT_H
#define TRACK_YOU_CORE_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="track_you_core_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18track_you_core_ios18TrackYouCorePlugin")
@interface TrackYouCorePlugin : NSObject <CLLocationManagerDelegate, FlutterPlugin, FlutterStreamHandler>
