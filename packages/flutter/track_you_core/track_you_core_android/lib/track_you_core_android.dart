...
/// The Android implementation of [TrackYouCorePlatform].
class TrackYouCoreAndroid extends TrackYouCorePlatform {
  ...
  static void registerWith() {
    TrackYouCorePlatform.instance = TrackYouCoreAndroid();
  }
